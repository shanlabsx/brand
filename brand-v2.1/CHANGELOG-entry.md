...
- `assets/icons/favicon.svg` restated on a 16px grid (1:32 of the master, same 3 : 1 : 4 proportions). The 1.0.0 mark's gaps resolved to 0.83px at the documented 16px minimum; the 32-unit grid puts them on exactly 1px.
