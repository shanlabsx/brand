...
- `assets/icons/favicon.svg` is now a **separate 16px-grid drawing**, not a scaled master. `favicon-16.png` and `favicon-32.png` come from it; 48px and above come from the master.
